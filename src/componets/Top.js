        ...
        <div className={styles.product}>
            ...
            <div className={styles.product_grid}>
                <div className={styles.eki}>
                    ...
                    general household items from verified suppliers.
                     Creating opportunities for sellers to meet the needs of buyers globally.
                    </p>
                </div>
                </div>
                ...
                <div className={styles.p_details}>
                    ...
                    <p>
                    A shipping marketplace with modernized shipping technology that creates visibility 
                    for local shippers
                     and their top counterparts, making shipping a breeze for every customer. 
                    </p>
                </div>
                </div>
                ...
                <img src="/images/jollificate-screen.svg" className={styles.p_screen} />
                <div className={styles.p_details}>
                    <img src="/images/jollificate-icon.svg" />
                    <p>
                    An online celebration portal for electronic gift cards and rewards 
                    where users can celebrate anyone and everyone.
                    </p>
                </div>
                </div>
            </div>
